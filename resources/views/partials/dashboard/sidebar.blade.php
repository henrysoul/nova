<div class="sidebar-menu-content" style="min-height: 100vh;">
    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
        <li class="nav-item">
            <a href="{{ route('home') }}" class="nav-link {{ Request::is('home') ? 'menu-active' : '' }}"><i
        ...
        {{-- <li class="nav-item sidebar-nav-item">
            <a href="#" class="nav-link"><i class="flaticon-classmates"></i><span>Settings</span></a>
            <ul class="nav sub-group-menu">
                <li class="nav-item">
                    <a href="{{ url('session') }}" class="nav-link"><i class="fas fa-angle-right"></i>Session</a>
                </li>
                <li class="nav-item">
